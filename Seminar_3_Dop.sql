DROP DATABASE IF EXISTS Seminar_3_dop;
CREATE DATABASE Seminar_3_dop;
USE Seminar_3_dop;
...
-- Создадим архив документов по месяцам 
SELECT * FROM media;

UPDATE media
SET created_at = '2023-06-16 20:47:52'
WHERE id = 1;
UPDATE media
SET created_at = '2023-05-16 20:47:52'
WHERE id = 2;
UPDATE media
SET created_at = '2023-04-16 20:47:52'
WHERE id = 4;
UPDATE media
SET created_at = '2023-04-16 20:47:52'
WHERE id = 7;
